      ...
      <el-table ref="adminTable" :data="list" style="width: 100%;" v-loading="listLoading" border>
        ...
        <el-table-column label="权限" width="120" align="center">
          <template slot-scope="scope">
            <span v-if="scope.row.admin_id == 1">超级管理员</span>
            <span v-if="scope.row.admin_id == 2">管理</span>
            <span v-if="scope.row.admin_id == 3">内勤</span>
            <span v-if="scope.row.admin_id == 4">销售</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="最后登录" width="160" align="center">
          <template slot-scope="scope">{{scope.row.last_time | formatDateTime}}</template>
        </el-table-column>
<!--         <el-table-column label="是否启用" width="140" align="center">
    ...
    <el-dialog :title="isEdit?'编辑用户':'添加用户'" :visible.sync="dialogVisible" width="40%">
      <el-form :model="admin" ref="adminForm" label-width="150px" size="small">
        <el-form-item label="帐号：">
          <el-input v-model="admin.admin_name" style="width: 250px"></el-input>
        </el-form-item>
        ...
        <el-form-item label="权限: ">
          <el-select v-model="admin.admin_id" placeholder="请选择" size="small" style="width: 80%">
    ...
    <el-dialog title="更改权限" :visible.sync="allocDialogVisible" width="30%">
...
import { fetchList, createAdmin, allocRole, updateAdmin, deleteAdmin } from '@/api/permission';
  ...
  methods: {
    ...
    handleDialogConfirm() {
      this.$confirm('是否要确认?', '提示', {
        ...
        if (this.isEdit) {
          ...
          params.append('admin_name',this.admin.admin_name);
          params.append('password',this.admin.password);
          params.append('admin_id',this.admin.admin_id);
          params.append('status',this.admin.status);
    ...
    handleAllocDialogConfirm() {
      this.$confirm('是否要确认?', '提示', {
        ...
        params.append("admin_id", this.allocRoleIds);
    ...
    handleSelectRole(index, row) {
      ...
      this.allocRoleIds = row.admin_id;
    },
    getList() {
